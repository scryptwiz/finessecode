const HomeHero = () => {
  return (
    <div className="w-full md:h-[36rem] flex">
        <div className="max-w-6xl mx-auto md:h-[36rem] w-full flex lg:flex-row flex-col">
            <div className="md:w-fit mx-auto lg:py-0 text-center lg:text-left py-16 lg:w-2/5 px-5 xl:px-0 my-auto gap-5 flex flex-col">
                ...
                <button className="text-white hover:border-finesseBlue border hover:bg-none hover:text-finesseBlue transition-all ease-in-out duration-500 mx-auto lg:m-0 w-fit px-7 py-2.5 rounded text-lg bg-gradient-to-r to-indigo-500 from-finesseBlue">Discover More</button>
            </div>
